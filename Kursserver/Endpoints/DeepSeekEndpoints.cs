...
namespace Kursserver.Endpoints
{
    ...
    {
        public static void MapDeepSeekEndpoints(this WebApplication app)
        {
            var group = app.MapGroup("api/deepseek").WithTags("AI");
                ...
                HttpContext context) =>
            {
                ...
                try
                {
                    ...
                    var result = await deepSeekService.GetCompletionAsync(prompt);
